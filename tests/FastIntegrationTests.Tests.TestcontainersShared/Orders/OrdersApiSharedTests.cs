namespace FastIntegrationTests.Tests.TestcontainersShared.Orders;

/// <summary>
/// Тесты HTTP-уровня: GetAll, GetById, Create, статусные переходы и сквозные сценарии для OrdersController.
/// Контейнер общий на процесс; БД и TestServer создаются на каждый тест.
/// </summary>
public class OrdersApiSharedTests : SharedApiTestBase
{
    [Fact]
