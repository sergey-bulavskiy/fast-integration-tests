...
/// </summary>
public class SuppliersApiContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="SuppliersApiContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public SuppliersApiContainerTests(ContainerFixture fixture) : base(fixture) { }
