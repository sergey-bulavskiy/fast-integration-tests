...
/// <summary>
/// Тесты сервисного уровня: GetAll, GetById, Create, Update, Delete, Activate, Deactivate для SupplierService.
/// Каждый тест создаёт изолированную БД в реальном контейнере PostgreSQL.
/// </summary>
public class SupplierServiceContainerTests : IAsyncLifetime, IClassFixture<ContainerFixture>
{
    ...
    /// <summary>
    /// Создаёт новый экземпляр <see cref="SupplierServiceContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public SupplierServiceContainerTests(ContainerFixture fixture) => _fixture = fixture;
