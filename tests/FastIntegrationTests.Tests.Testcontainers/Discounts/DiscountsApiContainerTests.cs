...
/// </summary>
public class DiscountsApiContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="DiscountsApiContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public DiscountsApiContainerTests(ContainerFixture fixture) : base(fixture) { }
