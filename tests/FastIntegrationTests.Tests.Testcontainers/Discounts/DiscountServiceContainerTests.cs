...
/// </summary>
public class DiscountServiceContainerTests : IAsyncLifetime, IClassFixture<ContainerFixture>
{
    ...
    /// <summary>
    /// Создаёт новый экземпляр <see cref="DiscountServiceContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public DiscountServiceContainerTests(ContainerFixture fixture) => _fixture = fixture;
