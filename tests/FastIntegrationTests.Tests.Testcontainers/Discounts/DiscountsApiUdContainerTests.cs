...
/// </summary>
public class DiscountsApiUdContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="DiscountsApiUdContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public DiscountsApiUdContainerTests(ContainerFixture fixture) : base(fixture) { }
