...
/// </summary>
public class ReviewsApiCrContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="ReviewsApiCrContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public ReviewsApiCrContainerTests(ContainerFixture fixture) : base(fixture) { }
