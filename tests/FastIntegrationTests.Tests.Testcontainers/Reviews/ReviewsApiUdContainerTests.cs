...
/// </summary>
public class ReviewsApiUdContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="ReviewsApiUdContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public ReviewsApiUdContainerTests(ContainerFixture fixture) : base(fixture) { }
