...
/// <summary>
/// Тесты сервисного уровня: GetAll, GetById, Create, Delete, Approve, Reject для ReviewService.
/// Каждый тест создаёт изолированную БД в реальном контейнере PostgreSQL.
/// </summary>
public class ReviewServiceContainerTests : IAsyncLifetime, IClassFixture<ContainerFixture>
{
    ...
    /// <summary>
    /// Создаёт новый экземпляр <see cref="ReviewServiceContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public ReviewServiceContainerTests(ContainerFixture fixture) => _fixture = fixture;
