...
/// </summary>
public class ReviewsApiContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="ReviewsApiContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public ReviewsApiContainerTests(ContainerFixture fixture) : base(fixture) { }
