...
/// </summary>
public class CustomerServiceUdContainerTests : IAsyncLifetime, IClassFixture<ContainerFixture>
{
    ...
    /// <summary>
    /// Создаёт новый экземпляр <see cref="CustomerServiceUdContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public CustomerServiceUdContainerTests(ContainerFixture fixture) => _fixture = fixture;
