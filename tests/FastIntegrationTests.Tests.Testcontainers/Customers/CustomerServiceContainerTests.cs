...
/// <summary>
/// Тесты сервисного уровня: GetAll, GetById, Create, Update, Delete, статусные переходы для CustomerService.
/// Каждый тест создаёт изолированную БД в реальном контейнере PostgreSQL.
/// </summary>
public class CustomerServiceContainerTests : IAsyncLifetime, IClassFixture<ContainerFixture>
{
    ...
    /// <summary>
    /// Создаёт новый экземпляр <see cref="CustomerServiceContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public CustomerServiceContainerTests(ContainerFixture fixture) => _fixture = fixture;
