...
/// </summary>
public class CategoriesApiUdContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="CategoriesApiUdContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public CategoriesApiUdContainerTests(ContainerFixture fixture) : base(fixture) { }
