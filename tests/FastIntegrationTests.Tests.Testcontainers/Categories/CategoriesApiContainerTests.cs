...
/// </summary>
public class CategoriesApiContainerTests : ContainerApiTestBase
{
    /// <summary>
    /// Создаёт новый экземпляр <see cref="CategoriesApiContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public CategoriesApiContainerTests(ContainerFixture fixture) : base(fixture) { }
