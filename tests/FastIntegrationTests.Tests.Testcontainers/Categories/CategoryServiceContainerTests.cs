...
/// <summary>
/// Тесты сервисного уровня: GetAll, GetById, Create, Update, Delete для CategoryService.
/// Каждый тест создаёт изолированную БД в реальном контейнере PostgreSQL.
/// </summary>
public class CategoryServiceContainerTests : IAsyncLifetime, IClassFixture<ContainerFixture>
{
    ...
    /// <summary>
    /// Создаёт новый экземпляр <see cref="CategoryServiceContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public CategoryServiceContainerTests(ContainerFixture fixture) => _fixture = fixture;
