...
/// </summary>
public class ReviewServiceRespawnTests : RespawnServiceTestBase
{
    private IReviewService Sut = null!;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="ReviewServiceRespawnTests"/>.
    /// </summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public ReviewServiceRespawnTests(RespawnFixture fixture) : base(fixture) { }
