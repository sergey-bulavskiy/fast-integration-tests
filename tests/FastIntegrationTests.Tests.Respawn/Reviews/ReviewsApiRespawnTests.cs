...
/// </summary>
public class ReviewsApiRespawnTests : RespawnApiTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="ReviewsApiRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public ReviewsApiRespawnTests(RespawnApiFixture fixture) : base(fixture) { }
