...
/// </summary>
public class SuppliersApiUdRespawnTests : RespawnApiTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="SuppliersApiUdRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public SuppliersApiUdRespawnTests(RespawnApiFixture fixture) : base(fixture) { }
