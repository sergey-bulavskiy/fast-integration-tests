...
/// </summary>
public class SupplierServiceRespawnTests : RespawnServiceTestBase
{
    private ISupplierService Sut = null!;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="SupplierServiceRespawnTests"/>.
    /// </summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public SupplierServiceRespawnTests(RespawnFixture fixture) : base(fixture) { }
