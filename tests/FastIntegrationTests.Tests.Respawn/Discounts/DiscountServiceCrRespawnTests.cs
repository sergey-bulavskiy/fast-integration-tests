...
/// </summary>
public class DiscountServiceCrRespawnTests : RespawnServiceTestBase
{
    private IDiscountService Sut = null!;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="DiscountServiceCrRespawnTests"/>.
    /// </summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public DiscountServiceCrRespawnTests(RespawnFixture fixture) : base(fixture) { }
