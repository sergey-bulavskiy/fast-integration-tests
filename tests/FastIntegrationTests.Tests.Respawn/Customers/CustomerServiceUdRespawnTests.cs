...
/// </summary>
public class CustomerServiceUdRespawnTests : RespawnServiceTestBase
{
    private ICustomerService Sut = null!;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="CustomerServiceUdRespawnTests"/>.
    /// </summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CustomerServiceUdRespawnTests(RespawnFixture fixture) : base(fixture) { }
