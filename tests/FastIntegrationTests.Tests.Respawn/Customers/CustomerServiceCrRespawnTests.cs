...
/// </summary>
public class CustomerServiceCrRespawnTests : RespawnServiceTestBase
{
    private ICustomerService Sut = null!;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="CustomerServiceCrRespawnTests"/>.
    /// </summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CustomerServiceCrRespawnTests(RespawnFixture fixture) : base(fixture) { }
