...
/// </summary>
public class CustomerServiceRespawnTests : RespawnServiceTestBase
{
    private ICustomerService Sut = null!;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="CustomerServiceRespawnTests"/>.
    /// </summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CustomerServiceRespawnTests(RespawnFixture fixture) : base(fixture) { }
