...
/// </summary>
public class CustomersApiUdRespawnTests : RespawnApiTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="CustomersApiUdRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CustomersApiUdRespawnTests(RespawnApiFixture fixture) : base(fixture) { }
