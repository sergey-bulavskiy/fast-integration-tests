...
/// </summary>
public class CustomersApiRespawnTests : RespawnApiTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="CustomersApiRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CustomersApiRespawnTests(RespawnApiFixture fixture) : base(fixture) { }
