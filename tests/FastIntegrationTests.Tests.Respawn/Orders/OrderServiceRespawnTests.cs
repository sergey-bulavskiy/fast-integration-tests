...
/// </summary>
public class OrderServiceRespawnTests : RespawnServiceTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="OrderServiceRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public OrderServiceRespawnTests(RespawnFixture fixture) : base(fixture) { }
