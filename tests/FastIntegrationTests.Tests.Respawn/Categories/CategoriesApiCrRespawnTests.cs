...
/// </summary>
public class CategoriesApiCrRespawnTests : RespawnApiTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="CategoriesApiCrRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CategoriesApiCrRespawnTests(RespawnApiFixture fixture) : base(fixture) { }
