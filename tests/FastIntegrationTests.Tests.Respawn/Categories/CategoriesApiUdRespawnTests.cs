...
/// </summary>
public class CategoriesApiUdRespawnTests : RespawnApiTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="CategoriesApiUdRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CategoriesApiUdRespawnTests(RespawnApiFixture fixture) : base(fixture) { }
