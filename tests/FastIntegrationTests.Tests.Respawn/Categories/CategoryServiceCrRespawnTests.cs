...
/// </summary>
public class CategoryServiceCrRespawnTests : RespawnServiceTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="CategoryServiceCrRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CategoryServiceCrRespawnTests(RespawnFixture fixture) : base(fixture) { }
