...
/// </summary>
public class CategoryServiceRespawnTests : RespawnServiceTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="CategoryServiceRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CategoryServiceRespawnTests(RespawnFixture fixture) : base(fixture) { }
