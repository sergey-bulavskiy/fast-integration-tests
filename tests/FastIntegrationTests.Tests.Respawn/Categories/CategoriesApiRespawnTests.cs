...
/// <summary>
/// Тесты HTTP-уровня: GetAll, GetById, Create, Update, Delete для CategoriesController.
/// Каждый тест сбрасывает данные через Respawn (~1 мс), схема и TestServer сохраняются.
/// </summary>
public class CategoriesApiRespawnTests : RespawnApiTestBase
{
    /// <summary>Создаёт новый экземпляр <see cref="CategoriesApiRespawnTests"/>.</summary>
    /// <param name="fixture">Фикстура с контейнером и Respawner.</param>
    public CategoriesApiRespawnTests(RespawnApiFixture fixture) : base(fixture) { }
