...
/// </summary>
public class ProductServiceContainerTests_15 : ContainerServiceTestBase
{
    private IProductService Sut => ProductService;
    private IOrderService _orders => OrderService;

    /// <summary>
    /// Создаёт новый экземпляр <see cref="ProductServiceContainerTests"/>.
    /// </summary>
    /// <param name="fixture">Запущенный контейнер с СУБД.</param>
    public ProductServiceContainerTests_15(ContainerFixture fixture) : base(fixture) { }
